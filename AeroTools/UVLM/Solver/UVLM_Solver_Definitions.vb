...
Namespace UVLM.Solver
    ...
    Partial Public Class UVLMSolver
        ...
        Public Sub New(ByVal Model As VisualModel.Models.CalculationModel, ByVal Simulation As SimulationSettings, Optional ByVal GenerateStructure As Boolean = False)
            Lattices = New List(Of BoundedLattice)
            Settings = New SimulationSettings
