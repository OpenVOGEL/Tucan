...
Partial Class FormJetEngine
    ...
    Friend WithEvents gbPosition As Windows.Forms.GroupBox
    Friend WithEvents gbDimensions As Windows.Forms.GroupBox
    Friend WithEvents gbOrientation As Windows.Forms.GroupBox
